<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeletePayment.aspx.cs" Inherits="ExpenseManagementClient.Payment.DeletePayment" %>
...
<body>
    ...
    <form id="form1" class="container mt-4" runat="server">
        <div class="alert alert-light" role="alert">
            <h3 class="alert-heading" style="color:black">Are you sure you want to delete this payment?</h3>
