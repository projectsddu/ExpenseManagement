<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPayment.aspx.cs" Inherits="ExpenseManagementClient.Payment.AddPayment" %>
...
<body>
    ...
    <form id="form1" class="container mt-4" runat="server">
        ...
        <asp:Button ID="buttonAddPayment" type="submit" class="btn btn-success mb-4"  runat="server" Text="Add Payment" OnClick="buttonAddPayment_Click" />
    </form>
