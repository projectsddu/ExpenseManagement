<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddExpense.aspx.cs" Inherits="ExpenseManagementClient.Expense.AddExpense1" %>
...
<body>
    ...
    <form id="form1" class="container mt-4" runat="server">
        ...
        <asp:Button ID="buttonAddExpense" type="submit" class="btn btn-success"  runat="server" Text="Add Expense" OnClick="buttonAddExpense_Click" />
